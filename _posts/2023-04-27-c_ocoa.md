...
Eskil was generous enough to allow me to write about how this problem was solved and also to [open source the final product](#sourcecode).
...
If you're not interested in the internals of the code generator, [go directly to the conclusion](#conclusion).
